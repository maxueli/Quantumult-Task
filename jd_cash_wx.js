...
[task_local]
#微信签到领现金
12 0,6 * * * jd_cash_wx.js, tag=微信签到领现金, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
 */
...
function taskUrl(functionId, body = {}) {
  return {
    url: `${JD_API_HOST}?functionId=${functionId}&body=${encodeURIComponent(
      JSON.stringify(body)
    )}&&appid=CashRewardMiniH5Env&clientVersion=9.2.0&loginWQBiz=interact`,
    headers: {
      Cookie: cookie,
      Host: "api.m.jd.com",
